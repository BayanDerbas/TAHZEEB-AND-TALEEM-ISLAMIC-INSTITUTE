...
import '../../color_.dart';
import 'ProfileStudentController.dart';

class profileStudent_screen extends StatefulWidget {
  const profileStudent_screen({super.key});
  @override
  State<profileStudent_screen> createState() => _ProfileStudentScreenState();
}

class _ProfileStudentScreenState extends State<profileStudent_screen> {
