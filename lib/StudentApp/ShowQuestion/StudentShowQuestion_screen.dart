...
import 'StudentQuestionShowController.dart';




class StudentShowQuestion_screen extends StatefulWidget {
  const StudentShowQuestion_screen({super.key});

  @override
  State<StudentShowQuestion_screen> createState() => _ConsultAnswerScreenState();
}

class _ConsultAnswerScreenState extends State<StudentShowQuestion_screen> {
  final LoginnnnnController _loginController = Get.put(LoginnnnnController());
  final StudentQuestionShowController _showController = Get.put(StudentQuestionShowController());
  ...
  void initState() {
    ...
    if(answered==0){
      ...
      _showController.StudentfetchReplyByQuestionId(consultId!);
    }
  }
  @override
