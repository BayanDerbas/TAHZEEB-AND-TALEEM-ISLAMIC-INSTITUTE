...
class StudentQuestionController extends GetxController {
  ...
  Future<void> fetchQuestions() async {
    ...
    var request = http.Request('GET', Uri.parse('http://127.0.0.1:8000/api/auth/student/student_showAllQuestion'));
