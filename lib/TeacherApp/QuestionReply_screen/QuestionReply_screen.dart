...
import 'package:sprint1/TeacherApp/QuestionReply_screen/QuestionShowController.dart';
import 'package:sprint1/color_.dart';
import 'package:sprint1/login/loginController.dart';

import 'QuestionResponseController.dart';


class QuestionAnswer_screen extends StatefulWidget {
  const QuestionAnswer_screen({super.key});

  @override
  State<QuestionAnswer_screen> createState() => _ConsultAnswerScreenState();
}

class _ConsultAnswerScreenState extends State<QuestionAnswer_screen> {
  final LoginnnnnController _loginController = Get.put(LoginnnnnController());
  final QuestionShowController _showController = Get.put(QuestionShowController());
  final QuestionReplyController _replyController = Get.put(QuestionReplyController());
  ...
  void initState() {
    ...
    if(answered==0){
      ...
      _replyController.fetchReplyByQuestionId(consultId!);
    }
  }
  @override
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Obx(() {
                                          if (_showController.consultations.isNotEmpty) {
                                            return Text(
                                              _showController.consultations.last.question,
              ...
              Positioned(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    await _replyController.fetchReplyByQuestionId(consultId!);
