...
import '../../color_.dart';
import 'TeacherQuestoinController.dart';

class TeacherQuestionScreen extends StatefulWidget {
  const TeacherQuestionScreen({super.key});

  @override
  State<TeacherQuestionScreen> createState() => _TeacherQuestionScreenState();
}

class _TeacherQuestionScreenState extends State<TeacherQuestionScreen> {
  List<String> itemTitle = ["تم الرد", "لم يرد عليها"];
  int selectedIndex = 0;

  final TeacherQuestionController controller = Get.put(TeacherQuestionController());
                                ...
                                return ListTile(
                                  ...
                                  onTap: () async {
                                    var result = await Get.toNamed(
                                      '/QuestionAnswer_screen',
                                      arguments: {
                                        'id': question[index].id,
                                        'answered': question[index].question,
                                      },
                                    );
